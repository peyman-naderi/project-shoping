            ...
            <div className="w-[83%] mx-auto mt-10">
                ...
                <div className="mx-auto mt-10 lg:flex grid grid-cols-2 pb-10  lg:gap-x-4 xl:gap-x-8 gap-x-3 items-center border-b border-solid border-blue-900">
                    ...
                    <div className=" lg:w-[18%]  mr-8">
                        ...
                        <ol>
                            <li className="w-[277px] text-base font-bold mb-3 ">صفحه اصلی</li>
                            <li className="w-[277px] text-base font-bold mb-3 ">تماس با ارپی کالا</li>
                            <li className="w-[277px] text-base font-bold mb-3 ">درباره ارپی کالا</li>
                            <li className="w-[277px] text-base font-bold mb-3 ">فروشنده شوید</li>
                    ...
                    <div className=" lg:w-[18%] xl:block hidden -mt-12">
                        ...
                        <ol>
                            <li className="flex gap-x-1 ">
                                ...
                                <p href="" className="w-[277px] text-base font-bold mb-2"> 1489 934 0921</p>
                            </li>
                            <li className="flex gap-x-1">
                                ...
                                <p href="" className="w-[277px] text-base font-bold mb-3">اصفهان - گلزار جنوبی</p>
                            </li>
                            <li className="flex gap-x-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 0 1 1.037-.443 48.282 48.282 0 0 0 5.68-.494c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                            </svg>
                            <p className="w-[277px] text-base font-bold mb-2">Salam@RPKala.co</p>
                            </li>
                    ...
                    <div className=" lg:w-[18%] ">
                        ...
                        <ol>
                            ...
                            <li className="w-[277px] text-base font-bold mb-3 ">بازگشت کالا</li>
                            <li className="w-[277px] text-base font-bold mb-3 ">حریم خصوصی</li>
                            <li className="w-[277px] text-base font-bold mb-3 ">سنجش رضایت مندی</li>
                        </ol>
                    </div>
