    ...
    return(
        <div className="flex flex-row gap-x-2 w-[86%] lg:w-full  mx-auto  mt-5 h-[61px]">
            <div className="lg:bg-blue-700 rounded-r-lg rounded-l-lg lg:rounded-l-3xl w-full bg-blue-700 lg:w-[1740px] ">
                <div className="flex gap-x-10 lg:gap-x-6 items-center mt-5 justify-center lg:justify-start lg:mr-28">
            ...
            <div className=" lg:basis-64 lg:flex hidden  items-center justify-center text-base font-semibold">در RpKala فروشنده شوید!</div>
