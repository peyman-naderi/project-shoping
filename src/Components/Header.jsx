      ...
      <>
        <div className="flex justify-between items-center lg:gap-x- w-[86%] h-42  mx-auto mt-5">
            ...
            <div className="flex items-center justify-center gap-x-5">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex lg:hidden w-10 h-10">
            ...
            {/* shop in mobile*/}
               <svg className="w-10 h-10 flex lg:hidden" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
